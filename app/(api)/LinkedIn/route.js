...
export async function GET(request) {
  ...
  const prompt = `
  Act as a user who created a video on youtube now create a post for LinkedIn. The character limit must be below 1000 also add necessary hashtags at the end of the post and don't include placeholder in the response. Use the below transcript to frame your response:
